<?php
    ...
    if(sizeof($parts) > 0)
    {
        ...
        //    //test
            ...
            //select table -> branch
            $sql = "SELECT branch.*,'$luckyDrawSpend' LuckyDrawSpend,'$wordAdd' WordAdd, '$wordNo' WordNo FROM $jummumOM.Branch where status = 1 and customerApp = 1 and branchID = '$branchID';";
