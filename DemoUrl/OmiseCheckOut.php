<?php
    ...
    if($doReceiptProcess || $charge["status"] == "successful")//omise status
    {
        ...
        //-----****************************
        //get pushSync Device in DEMO_JUMMUM_OM
...
//        $msg = 'New order coming!! receipt No:' . $receiptNoID . ' ,noti time:' . date("Y/m/d H:i:s");
        ...
        mysqli_commit($con);
        sendPushNotificationToDeviceWithPath($pushSyncDeviceTokenReceiveOrder,'./../DemoJummumOM/','jill',$msg,$receiptID,'printKitchenBill',1);
